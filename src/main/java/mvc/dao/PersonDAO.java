...
public class PersonDAO {
    ...
    public List<Person> index() {
        ...
        public void save (Person person) {
            jdbcTemplate.update("INSERT INTO Person VALUES(?,?,?,?,?,?)", person.getId(),person.getName(),person.getPosition(),person.getExperience(),person.getEmail(),person.getDepartment());
        }
